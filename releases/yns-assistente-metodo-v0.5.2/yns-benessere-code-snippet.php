...
final class YNS_Benessere_V052 {
  ...
  static function rest(){
    register_rest_route('yoganostress/v1','/benessere',[
      ...
      'callback'=>function(WP_REST_Request $r){
        ...
        return rest_ensure_response(['answer'=>$a,'category'=>$c,'method_url'=>$u,'cta'=>$cta,'engine'=>'local-v0.5.2']);
      }
    ]);
  }
