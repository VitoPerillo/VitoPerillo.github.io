...
final class YNS_Benessere_V051 {
  ...
  static function cat($q){
    ...
    $m=[
      ...
      'fees'=>['prezzo','prezzi','costo','costi','quota','quote','abbonamento','quanto costa','quanto viene'],
      'address'=>['indirizzo','dove siete','dove si trova','dove vi trovate','sede','come arrivo','come arrivare'],
  ...
  static function data($c){
    $x=[
      ...
      'nidra'=>['Se cerchi meditazione o mindfulness, nel Metodo Yoganostress Yoga Nidra è particolarmente indicato: integra anche pratiche di mindfulness e la consapevolezza è il filo conduttore. Hatha Yoga e Yoga Nidra sono però complementari: hanno gli stessi obiettivi e utilizzano strumenti diversi. Quando possibile consigliamo di frequentare entrambi, almeno due pratiche alla settimana complessive, anche di più. Gli orari sono flessibili: non sei legato a un giorno e a un orario fissi.',self::N,'Approfondisci Yoga Nidra'],
      ...
      'hatha'=>['Per schiena, cervicale, rigidità e postura, Hatha Yoga è il percorso di gruppo più naturale da valutare. Nel Metodo Yoganostress, però, Hatha Yoga e Yoga Nidra sono complementari: hanno gli stessi obiettivi e utilizzano strumenti diversi. Quando possibile consigliamo di frequentare entrambi, almeno due pratiche alla settimana complessive, anche di più. Gli orari sono flessibili: puoi scegliere le pratiche disponibili senza essere legato a un giorno e a un orario fissi.',self::H,'Approfondisci Hatha Yoga'],
      'stress'=>['Per stress e ansia Hatha Yoga e Yoga Nidra possono lavorare in modo complementare: hanno gli stessi obiettivi del Metodo Yoganostress ma utilizzano strumenti diversi. Per questo, quando possibile, consigliamo di frequentare entrambi almeno due volte alla settimana complessivamente, anche di più. Gli orari sono flessibili e puoi scegliere di volta in volta quando praticare.',self::M,'Scopri come funziona il Metodo Yoganostress'],
      ...
      'fees'=>['Per scegliere una quota ha più senso prima provare: ti consigliamo la Prima Esperienza Yoganostress, così conosci il Metodo e puoi capire come frequentare. Se vuoi invece vedere direttamente le quote aggiornate, scrivimi ancora “voglio vedere i prezzi” e ti indico la pagina delle quote.',self::F,'Scopri la Prima Esperienza'],
      'address'=>['La sede Yoganostress è in Via Vittorio Spinazzola 52, Roma, zona Monteverde/Gianicolense. La segreteria riceve solo su appuntamento.',self::M,'Scopri il Metodo Yoganostress'],
      ...
      'other'=>['Non voglio mandarti automaticamente alla pagina del Metodo se la domanda richiede un’informazione precisa. Prova a formulare la domanda con qualche dettaglio in più e ti rispondo nel modo più pertinente possibile.',self::M,'Scopri il Metodo Yoganostress']
    ];
    return $x[$c]??$x['other'];
  }
  ...
  static function foot(){
    ...
    <style>
    .ynsba{max-width:660px;margin:0 auto;padding:clamp(.9rem,3vw,1.35rem);border:1px solid #ded5c7;border-radius:18px;background:linear-gradient(180deg,#fbfaf7 0%,#f5f1e8 100%);color:#413a31;box-shadow:0 10px 34px rgba(74,61,42,.12);font-family:inherit}.ynsba__eyebrow{font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#7b674d}.ynsba h2{margin:.28rem 2.4rem .4rem 0;font-size:clamp(1.28rem,4.3vw,1.85rem);line-height:1.12}.ynsba__intro{margin:0 0 .8rem;line-height:1.45;font-size:.96rem}.ynsba__form label{display:block;font-weight:700;margin:.35rem 0}.ynsba__row{display:grid;grid-template-columns:1fr auto;gap:.45rem}.ynsba input{min-width:0;border:1px solid #c9bcaa;background:rgba(255,255,255,.9);color:inherit;border-radius:11px;padding:.78rem .9rem;font:inherit}.ynsba input:focus{outline:none;border-color:#8c7657;box-shadow:0 0 0 3px rgba(140,118,87,.13)}.ynsba button[type=submit],.ynsba__cta{border:0;border-radius:11px;padding:.78rem .95rem;font:inherit;font-weight:700;cursor:pointer;text-decoration:none;background:#7b674d;color:#fff}.ynsba__status{min-height:.8em;margin:.4rem 0 0;font-size:.84rem;color:#716557}.ynsba__answer{margin-top:.5rem;padding:.8rem;border:1px solid #e0d7ca;border-radius:12px;background:rgba(255,255,255,.74);line-height:1.5}.ynsba__answer p{margin:0 0 .7rem}.ynsba__cta{display:inline-block}.ynsba__suggestions{margin-top:.65rem;border-top:1px solid rgba(123,103,77,.18);padding-top:.55rem}.ynsba__hint{margin:.1rem 0 .4rem;font-size:.87rem;color:#655a4c}.ynsba__hint--small{margin-top:.55rem}.ynsba__chips{display:flex;gap:.35rem;flex-wrap:wrap}.ynsba__chip{border:1px solid #cdbfae;background:#fffaf3;color:#56493a;border-radius:999px;padding:.4rem .6rem;cursor:pointer;font:inherit;font-size:.82rem;line-height:1.15}.ynsba__chip--need{background:#efe7d8;border-color:#c8b394}.ynsba__chip:hover{background:#e8ddcb}.ynsba__other{margin-top:.55rem;font-size:.85rem}.ynsba__other summary{cursor:pointer;color:#75654f;font-weight:700}.ynsba__chips--other{margin-top:.4rem}.ynsba-float{position:fixed;right:14px;bottom:84px;z-index:99990}.ynsba-float__trigger{border:1px solid rgba(255,255,255,.45);border-radius:999px;padding:.66rem .84rem;font:inherit;font-weight:700;cursor:pointer;background:#7b674d;color:#fff;box-shadow:0 8px 24px rgba(62,49,32,.22)}.ynsba-float__panel{position:absolute;right:0;bottom:calc(100% + 9px);width:min(90vw,680px);max-height:min(72vh,650px);overflow:auto;background:#f8f5ef;border:1px solid #d9cebf;border-radius:20px;box-shadow:0 18px 52px rgba(50,39,25,.22);padding:46px .2rem .2rem}.ynsba-float__close{position:absolute!important;right:10px!important;top:8px!important;z-index:2147483647!important;display:flex!important;align-items:center;justify-content:center;width:40px!important;height:40px!important;padding:0!important;border:2px solid #b9a58d!important;border-radius:50%!important;background:#fffaf3!important;color:#413a31!important;font-size:1.6rem!important;font-weight:700!important;line-height:1!important;cursor:pointer!important;box-shadow:0 2px 10px rgba(50,39,25,.18)!important}
    @media(max-width:560px){.ynsba{padding:.8rem}.ynsba h2{font-size:1.25rem;margin-right:2.2rem}.ynsba__intro{font-size:.9rem}.ynsba__row{grid-template-columns:1fr auto}.ynsba button[type=submit]{padding:.7rem .75rem}.ynsba__chip{font-size:.78rem;padding:.36rem .5rem}.ynsba-float{right:10px;bottom:82px}.ynsba-float__trigger{width:auto;max-width:72vw;padding:.6rem .76rem}.ynsba-float__panel{position:fixed;left:10px;right:10px;bottom:60px;width:auto;max-height:68vh}.ynsba-float__close{position:fixed!important;right:18px!important;top:auto!important;bottom:calc(68vh + 8px)!important;margin:0!important;float:none!important}}
    </style>
    <div class="ynsba-float" data-ynsba-float><button type="button" class="ynsba-float__trigger" aria-expanded="false">Posso aiutarti?</button><div class="ynsba-float__panel" hidden><button type="button" class="ynsba-float__close" aria-label="Chiudi assistente" title="Chiudi">×</button><?php echo self::box(); ?></div></div>
    <script>
    (()=>{const E=<?php echo wp_json_encode($ep); ?>;const render=(b,d)=>{b.replaceChildren();const p=document.createElement('p');p.textContent=d.answer;b.appendChild(p);const a=document.createElement('a');a.className='ynsba__cta';a.href=d.method_url||'#';a.textContent='Leggi la pagina consigliata';a.target='_self';a.addEventListener('click',e=>{const u=new URL(a.href,location.href),same=u.origin===location.origin&&u.pathname.replace(/\/$/,'')===location.pathname.replace(/\/$/,'');document.querySelectorAll('[data-ynsba-float]').forEach(w=>{const panel=w.querySelector('.ynsba-float__panel'),trigger=w.querySelector('.ynsba-float__trigger');if(panel)panel.hidden=true;if(trigger)trigger.setAttribute('aria-expanded','false')});if(same){e.preventDefault();const id=u.hash?decodeURIComponent(u.hash.slice(1)):'';const el=id?document.getElementById(id):null;if(el)el.scrollIntoView({behavior:'smooth',block:'start'});else window.scrollTo({top:0,behavior:'smooth'});history.pushState(null,'',u.pathname+u.search+u.hash)}else{e.preventDefault();location.assign(u.href)}});b.appendChild(a);b.hidden=false};document.querySelectorAll('[data-ynsba]').forEach(r=>{const f=r.querySelector('.ynsba__form'),i=r.querySelector('input[name=q]'),s=r.querySelector('.ynsba__status'),b=r.querySelector('.ynsba__answer');const ask=async q=>{s.textContent='Sto cercando nel Metodo Yoganostress…';b.hidden=true;try{const x=await fetch(E,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({q})});const d=await x.json();if(!x.ok)throw 0;render(b,d);s.textContent=''}catch(e){s.textContent='Non riesco a completare la ricerca in questo momento. Puoi comunque partire dal Metodo Yoganostress.'}};f.addEventListener('submit',e=>{e.preventDefault();const q=i.value.trim();if(q)ask(q)});r.querySelectorAll('[data-query]').forEach(x=>x.addEventListener('click',()=>{i.value=x.dataset.query;ask(x.dataset.query)}))});document.querySelectorAll('[data-ynsba-float]').forEach(w=>{const t=w.querySelector('.ynsba-float__trigger'),p=w.querySelector('.ynsba-float__panel'),x=w.querySelector('.ynsba-float__close'),open=o=>{p.hidden=!o;p.style.setProperty('display',o?'block':'none','important');t.setAttribute('aria-expanded',o?'true':'false')};open(false);t.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();open(p.hidden||getComputedStyle(p).display==='none')});x.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();open(false)});document.addEventListener('keydown',e=>{if(e.key==='Escape')open(false)})})})();
    </script>
    <?php
  }
}
